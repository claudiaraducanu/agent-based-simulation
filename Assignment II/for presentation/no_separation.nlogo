...
@#$#@#$#@
<experiments>
  <experiment name="global1" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="10000"/>
    <metric>dead-agvs</metric>
    <metric>length delivery-times</metric>
    <metric>mean delivery-times</metric>
    <metric>mean [ battery-life ] of agvs</metric>
    <enumeratedValueSet variable="number-of-robots">
      <value value="4"/>
      <value value="7"/>
      <value value="10"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="luggage-time">
      <value value="5"/>
      <value value="10"/>
      <value value="20"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="global-KS1">
      <value value="0.1"/>
      <value value="0.5"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="global-KL1">
      <value value="0.1"/>
      <value value="0.5"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="global-KC1">
      <value value="0.1"/>
      <value value="0.5"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="global-KC2">
      <value value="0.1"/>
      <value value="0.5"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="global-KL2">
      <value value="0.1"/>
      <value value="0.5"/>
    </enumeratedValueSet>
  </experiment>
  <experiment name="global_4_10" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="10000"/>
    <metric>dead-agvs</metric>
    <metric>length delivery-times</metric>
    <metric>mean delivery-times</metric>
    <metric>1000 * length delivery-times / ticks</metric>
    <metric>mean [ battery-life ] of agvs</metric>
    <enumeratedValueSet variable="global-KS1">
      <value value="0.1"/>
      <value value="1"/>
